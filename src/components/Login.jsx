...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Card con blur — overflow hidden para el slide */}
        <div
        ...
        >
          {/* Slider track — ambas vistas en fila horizontal */}
          <div
            className="flex"
            style={{
              width: '200%',
          ...
          >
            ...
            <div className="w-1/2 p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      style={{ background: 'rgba(255,255,255,0.06)', border: error ? '1px solid rgba(239,68,68,0.5)' : '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(8px)' }}
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-400 mb-2 uppercase tracking-widest">Contraseña</label>
                  <div className="relative group">
                    <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-500 transition-colors group-focus-within:text-orange-400">
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg, #ea580c 0%, #c2410c 100%)', boxShadow: '0 4px 24px rgba(234,88,12,0.4)', transition: 'box-shadow 0.2s, opacity 0.2s' }}
                ...
                >
                  <span className="flex items-center justify-center gap-2">
                    {loading ? (
                      <><span className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />Iniciando sesión...</>
                    ) : (
                      <>Iniciar Sesión<svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" /></svg></>
                    )}
                  </span>
                </button>
            ...
            <div className="w-1/2 p-10 flex flex-col">
              ...
              {/* Icono */}
              <div className="mb-6 w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: 'rgba(234,88,12,0.12)', border: '1px solid rgba(234,88,12,0.25)' }}>
              ...
              <div className="mb-6 h-0.5 w-10 rounded-full" style={{ background: 'linear-gradient(90deg, #ea580c, #fb923c)' }} />

              <p className="text-gray-400 text-sm leading-relaxed mb-8">
                Para restablecer tu contraseña, comunícate directamente con el <span className="text-orange-400 font-semibold">Super Administrador</span> del sistema. Él podrá enviarte un nuevo enlace de acceso.
              </p>
              ...
              >
                <svg className="w-4 h-4 text-orange-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
                </svg>
                <p className="text-xs text-orange-300/80 leading-relaxed">
                  El Super Admin puede enviarte la invitación desde la sección <strong>Perfiles</strong> del sistema.
                </p>
              </div>
            </div>
