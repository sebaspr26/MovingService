  ...
  return (
    <>
      <button
        ...
        type="button"
        onClick={handleOpen}
        className="w-full flex items-center justify-between bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm gap-2 hover:border-gray-500 transition-colors focus:outline-none"
      >
      ...
      {open && rect && createPortal(
        <>
          ...
          <div
            ...
            style={{ top: rect.bottom + 4, left: rect.left, minWidth: Math.max(rect.width, 180), maxHeight: 260 }}
          >
            {options.map(opt => (
              <button
                key={opt.value}
              ...
              <div>
                ...
                <CustomSelect
                  ...
                  options={[
                    ...
                    { value: 'driver_lease', label: 'Driver LEASE' },
                  ]}
                />
              </div>
