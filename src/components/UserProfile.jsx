    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
        ...
        <div className="space-y-4">
          ...
          {/* Camión + credenciales en una sola card */}
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Datos de conductor</p>

            {driverLoading ? (
              <div className="space-y-3">
                {[1,2,3,4,5].map(i => <div key={i} className="h-7 bg-gray-800 rounded animate-pulse" />)}
              </div>
            ) : (
              <div className="space-y-4">
                {/* Camión */}
                <div className="flex items-center gap-3 pb-4 border-b border-gray-800">
                  ...
                  <div>
                    <p className="text-[10px] text-gray-500 uppercase tracking-wide">Camión asignado</p>
                    {assignedTruck
                      ? <p className="text-sm font-semibold text-white">{assignedTruck.name} <span className="text-gray-500 font-normal">#{assignedTruck.number}</span></p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <InfoRow label="Número" value={driverRecord?.license_number} />
                    <InfoRow label="Estado"
                      value={driverRecord?.license_state
                        ? `${driverRecord.license_state} · ${US_STATE_NAMES[driverRecord.license_state] || driverRecord.license_state}`
                        : null} />
                    <div className="col-span-2">
                      <p className="text-[10px] text-gray-500 uppercase tracking-wide mb-1">Vencimiento</p>
                      <p className={`text-sm font-medium flex items-center gap-2 ${expiryColor(driverRecord?.license_expiry)}`}>
                ...
                <div className="border-t border-gray-800 pt-4">
                  ...
                  <p className="text-[10px] text-gray-500 uppercase tracking-wide mb-1">Vencimiento</p>
                  <p className={`text-sm font-medium flex items-center gap-2 ${expiryColor(driverRecord?.medical_card_expiry)}`}>
